  ...
  return (
    <div className="p-0 container border m-auto mt-3">
      <div className="ms-3 row w-auto">
        <h3 className="col-8 py-3 mb-0">Create Profile</h3>
        <div className="col-4 py-3 mb-0">
          <NavLink to={`/Search-profile`} className="btn btn-outline-secondary">
            Search profiles
          </NavLink>
        </div>
      </div>
      <form className="border-top px-3 pb-3 p-auto">
        ...
        <div className="py-3 row g-3 align-items-center">
          <div className="col-12">
            <label htmlFor="addInfo" className="form-label">
              Additional info about Profile:
            </label>
            <textarea className="form-control pb-5" id="addInfo" rows="8" />
          </div>
        </div>
